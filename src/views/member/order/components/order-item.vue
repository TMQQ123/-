  ...
  <div class="order-item">
    ...
    <div class="body">
      ...
      <div class="column state">
        ...
        <!--3-待收货-查看物流  4-待评价-评价商品  5-已完成-查看评价 -->
      ...
      <div class="column action">
        ...
        <p v-if="[2, 3, 4, 5].includes(order.orderState)" @click="$router.push(`/member/checkout?orderId=${order.id}`)"><a href="javascript:;">再次购买</a></p>
...
export default {
  ...
  setup(props) {
    const { start, timeText } = usePayTime(props.order.countdown);
